...
import csv from './dht-hum.csv';
import { itemService } from '../../../services';

export default function ChartHum() {
  ...
  const getItems = () => {
    itemService
      ...
      .then((res) => {
        tableItems = [...res.data];
        tableItems = tableItems.filter((d) => d.item_name === 'dht/hum');
        ...
        table.forEach((row) => {
          ...
          const hum = row.item_status;
          yLabels.push(parseFloat(hum));
        });
